...
public:
	...
	LCInnerParticleIterator(int index_arg, int original_index_arg,
			int cell_size_arg, int width_arg, int height_arg, int depth_arg,
...
private:
	...
	/**
	 * cell number of the neighbours
	 * Look in the constructor to see more detailed information
	 */
