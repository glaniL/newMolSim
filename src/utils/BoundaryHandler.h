...
private:
	...
	/**
	 * precomputation fpr width * height
	 */
	int widhei;
	/**
	 * precomputation fpr width * depth
	 */
	int widdep;
	/**
	 * precomputation fpr height * depth
	 */
	int heidep;
	/**
	 * Iterator used for travelling through the halo cells
	 */
	...
	void backSide3D();
	void leftBackEdge3D();
	void leftFrontEdge3D();
	void leftLowerEdge3D();
	void leftUpperEdge3D();
	void lowerBackEdge3D();
	void lowerFrontEdge3D();
	void leftLowerBackCorner3D();
	void leftLowerFrontCorner3D();
	void leftUpperBackCorner3D();
	void leftUpperFrontCorner3D();

	void leftSide2D();
	void lowerSide2D();
	void leftLowerCorner2D();
	void leftUpperCorner2D();

	/**
	 * the iterator for the periodic calculations
	 */
	LCOuterParticleIterator iterator;
	/**
	 * the integers used for loops in the periodic calculations
	 */
	int i, j, k, l;
